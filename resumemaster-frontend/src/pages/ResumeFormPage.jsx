                    ...
                    <div>
                        ...
                        <div style={{
                            ...
                            {[
                                ...
                                {
                                    label: 'Experience',
                                    value: `${resumeData.experience.filter(e => e.company).length} position(s)`
                                },
                                {
                                    label: 'Education',
                                    value: `${resumeData.education.filter(e => e.school).length} school(s)`
                                },
                                {label: 'Skills', value: `${resumeData.skills.filter(Boolean).length} skill(s)`},
                            ].map((item, idx, arr) => (
